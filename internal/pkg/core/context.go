...
func (c *context) SessionUserInfo() proposal.SessionUserInfo {
	if c.ctx == nil {
		return SystemCtxSessionUserInfo
	}
...
var SystemCtx Context
var SystemCtxSessionUserInfo proposal.SessionUserInfo

func init() {
	SystemCtx = &context{}
	SystemCtxSessionUserInfo = proposal.SessionUserInfo{
		Device:   "test",
		IP:       "127.0.0.1",
		Location: "test",
	}
